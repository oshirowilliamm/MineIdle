function Minerio(_nome, _sprite, _cor, _valor, _peso, _drop = 1) constructor 
{
    nome    = _nome;
    sprite  = _sprite;
    cor     = _cor;
...
global.minerios = 
{
    #region Bioma 1
        ...
        //brutos
        b1_pedra:    new MinerioBruto("Stone",     0, cor_b1_pedra,    10, 2,  10, 1),
        b1_rocha1:   new MinerioBruto("Ametilita", 1, cor_b1_rocha1,   20, 4,  20, 5,  20, 2),
